...
class Settings(BaseSettings):
    DATABASE_URL: str = "postgresql://localhost/chekk"  # Default for development
    ...
    RESEND_FROM_EMAIL: str = "Timi <timi@chekk.dev>"
    ...
    CORS_ORIGINS: str = "*"  # Comma-separated list of allowed origins (e.g., "http://localhost:5173,https://chekk.vercel.app")
    FRONTEND_URL: str = "https://recruiting.chekk.dev"  # Base URL for the recruiting frontend (used in emails, links, etc.)
    LOG_LEVEL: str = "INFO"  # DEBUG, INFO, WARNING, ERROR
    OAUTH_CALLBACK_SECRET: str = "chekk-oauth-callback-secret"  # OAuth callback secret
